...
<div class="frame">
	...
	<form class="form" method="post" enctype="multipart/form-data">
		<input class="hidden" type="text" value="${accDetail.id }" name="id"/>  
		<input class="hidden" type="text" value="${page }" name="page"/> 
		...
		<div class="head">
			...
			<div class="title-content">
				<input class="ti form-control form-control-reg" type="text" name="title" value="${accDetail.title }" required/>
			</div>
		</div>
		...
		<div class="sel">
			<div class="search-bar-container-accom">
				<!-- -------- 구글 지도 검색창 ------ -->
			    <input class="form-control no-enter ti form-control-reg" id="autocomplete" name="form"  value="${accDetail.place }" type="text" required/>

			    <input class="hidden" type="text" value="${accDetail.latitude }" name="lat" id="lat"/>			           
			    <input class="hidden" type="text" value="${accDetail.longitude }" name="lng" id="lng"/>  
			    <input class="hidden" type="text" value="${accDetail.place }" name="place" id="place"/>  
			    <input class="hidden" type="text" value="${accDetail.locality }" name="locality" id="locality"/>  
			    <input class="hidden" type="text" value="${accDetail.country }" name="country" id="country"/>  
			    
  				<!-- -------- 달력 ------ -->

    	  		<input type="text" class="form-control calendar-reg ti form-control-reg" name="datefilter-reg" value="<fmt:formatDate value="${accDetail.startDate}" pattern="yyyy-MM-dd" /> ~ <fmt:formatDate value="${accDetail.endDate}" pattern="yyyy-MM-dd" />" placeholder="Search" required />
    	  		<input type="text" class="hidden" id="hidden-startDate" name="startDate" value="<fmt:formatDate value="${accDetail.startDate}" pattern="yyyy-MM-dd" />" placeholder="Search" required />
    	  		<input type="text" class="hidden" id="hidden-endDate" name="endDate" value="<fmt:formatDate value="${accDetail.endDate}" pattern="yyyy-MM-dd" />" placeholder="Search" required />
	    	</div>
		</div>
		<div class="text">
			<textarea name="content"  class="form-control form-textarea" required>${accDetail.context }</textarea>
		</div>
			...
			<div class="select_style">
				<select class="select" name="style">
					<c:forEach var="l" items="${styleList }">
						<c:choose>
							<c:when test="${l.id eq accDetail.styleId }">
		...
		<div class="select-char">
			<span>첨부 파일</span>
			<div>
 				<input type="file" value="" name="file" id="file-7" class="inputfile inputfile-6" data-multiple-caption="{count} files selected" multiple />
 		...
 		*/
 		...
 		;( function ( document, window, index )
 		{
			...
			<div class="bottun">
				<div class="cancel">
					<input type="button" value="취소" onclick="window.location.href='${root}/accompany/detail?id=${accDetail.id }'" class="btn btn-info chat"/>	
				</div>
				<div class="reg">
					<button class="btn btn-info chat" id="submit" type ="submit">수정</button>
				</div>
			</div>
