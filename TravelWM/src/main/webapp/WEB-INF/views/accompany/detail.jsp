	...
	<div class="frame">
		<div class="content">
			...
			<div class="head-detail">
				<div class="head-detail-wrapper">
					<div class="head-profile-pic" style="background-image: url('${root}${li.imgSrc }${li.imgName }');">
					</div>
					<div class="head-accompany-info">
						<div class="info-item item-nickname">${accDetail.writerNicName}</div>
						<div class="info-item item-country-date">
						${accDetail.country }&nbsp;${accDetail.place}</br>
						<fmt:formatDate value="${accDetail.startDate}" pattern="YY.MM.dd" />
						-
						<fmt:formatDate value="${accDetail.endDate}" pattern="YY.MM.dd" />		
						</div>
					</div>
				</div>
			</div>
